        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/estetica/tratamiento_acne.png"
                        alt="Tratamiento para Acné"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">acné</strong> es una afección de la piel que ocurre cuando los folículos pilosos se obstruyen con grasa y células muertas, causando espinillas, puntos negros e inflamación que puede dejar cicatrices permanentes.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo para el acné, eliminando bacterias, reduciendo la inflamación, regulando la producción de sebo y promoviendo la regeneración de la piel sin los efectos secundarios de tratamientos convencionales.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Reducción de lesiones activas',
                                    'Piel más limpia y clara',
                                    'Reducción de inflamación',
                                    'Menos brotes nuevos',
                                    'Mejora de cicatrices',
                                    'Control de grasa excesiva',
                                    'Piel más saludable y equilibrada'
                                ].map((resultado, index) => (
                                    <div key={index} className="flex items-start space-x-3">
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento natural combate el acné desde múltiples frentes
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Efecto Antibacteriano',
                                description: 'Elimina las bacterias causantes del acné de forma efectiva'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye enrojecimiento e hinchazón de las lesiones'
                            },
                            {
                                icon: Heart,
                                title: 'Regula el Sebo',
                                description: 'Equilibra la producción de grasa en la piel'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Mejora Cicatrices',
                                description: 'Ayuda a regenerar tejido y reducir marcas de acné'
                            },
                            {
                                icon: Clock,
                                title: 'Previene Brotes',
                                description: 'Reduce la frecuencia de nuevas erupciones'
                            },
                            {
                                icon: Star,
                                title: 'Sin Efectos Secundarios',
                                description: 'Tratamiento natural sin resequedad ni irritación'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción visible de lesiones activas, menos inflamación y mejora en la textura de la piel desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 8-12 sesiones para acné activo, seguido de sesiones de mantenimiento mensuales. Debe combinarse con higiene facial adecuada y cuidados de la piel.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Sin efectos de isotretinoína</li>
                                        <li>• No reseca la piel</li>
                                        <li>• Compatible con otros tratamientos</li>
                                        <li>• Mejora cicatrices existentes</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Reducción de lesiones activas</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede curar el acné?',
                                respuesta: 'La ozonoterapia es muy efectiva para controlar y reducir significativamente el acné. Muchos pacientes logran piel clara y prevención de brotes con tratamiento regular y buenos hábitos de cuidado de la piel.'
                            },
                            {
                                pregunta: '¿Funciona en acné severo?',
                                respuesta: 'Sí, la ozonoterapia es efectiva incluso en casos de acné severo. Puede combinarse con otros tratamientos médicos para resultados óptimos en casos más graves.'
                            },
                            {
                                pregunta: '¿El tratamiento deja marcas o cicatrices?',
                                respuesta: 'No, al contrario. La ozonoterapia ayuda a prevenir la formación de cicatrices y puede mejorar significativamente las cicatrices existentes de acné previo.'
                            },
                            {
                                pregunta: '¿Puedo usar maquillaje después del tratamiento?',
                                respuesta: 'Sí, puedes aplicar maquillaje después del tratamiento. Se recomienda usar productos no comedogénicos y libres de aceite para no obstruir los poros.'
                            },
                            {
                                pregunta: '¿A qué edad se puede hacer el tratamiento?',
                                respuesta: 'El tratamiento es seguro para adolescentes y adultos. Es especialmente útil en acné juvenil, acné adulto y acné hormonal en mujeres.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Logra una piel limpia y saludable. Agenda tu cita y recupera tu confianza.
                    </p>
