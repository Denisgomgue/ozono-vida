...
export default function FascitisPlantar() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/fascitis_plantar.png"
                        alt="Tratamiento para Fascitis Plantar"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">fascitis plantar</strong> es la inflamación de la fascia plantar, una banda gruesa de tejido que conecta el talón con los dedos del pie. Es una de las causas más comunes de dolor en el talón.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento altamente efectivo para la fascitis plantar, reduciendo la inflamación, aliviando el dolor y promoviendo la regeneración del tejido dañado sin necesidad de cirugía.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Actividad física intensa o deportes',
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    'Dolor intenso con los primeros pasos',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio de la fascitis plantar
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Reducción significativa del dolor en el talón y planta del pie'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la inflamación de la fascia plantar efectivamente'
                            },
                            {
                                icon: Heart,
                                title: 'Regenera la Fascia',
                                description: 'Promueve la cicatrización y regeneración del tejido dañado'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Sin Cirugía',
                                description: 'Tratamiento no invasivo sin riesgos quirúrgicos'
                            },
                            {
                                icon: Clock,
                            ...
                            },
                            {
                                ...
                                description: 'Efectos prolongados con alta tasa de éxito'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio del dolor desde las primeras sesiones, con mejoras progresivas en la capacidad de caminar y realizar actividades cotidianas sin molestias.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 5-8 sesiones para resultados óptimos, con excelentes tasas de recuperación completa.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Sin necesidad de reposo prolongado</li>
                                        <li>• Compatible con plantillas ortopédicas</li>
                                        <li>• Alta tasa de recuperación completa</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿Cuánto tiempo tarda en sanar la fascitis plantar con ozonoterapia?',
                                respuesta: 'La mayoría de pacientes experimentan mejoría significativa en 2-3 semanas con tratamiento regular. El protocolo completo de 5-8 sesiones suele resultar en recuperación completa en 4-6 semanas.'
                            },
                            {
                                pregunta: '¿Puedo hacer deporte durante el tratamiento?',
                                respuesta: 'Se recomienda reducir la actividad física de alto impacto durante el tratamiento. Actividades de bajo impacto como natación o ciclismo suelen ser bien toleradas. Tu médico te indicará cuándo retomar actividades deportivas.'
                            },
                            {
                                pregunta: '¿El tratamiento es doloroso?',
                                respuesta: 'El tratamiento es mínimamente invasivo y prácticamente indoloro. Puede haber una ligera molestia en el punto de aplicación, pero es temporal y bien tolerada por la mayoría de pacientes.'
                            },
                            {
                                pregunta: '¿Qué tan efectiva es la ozonoterapia comparada con otros tratamientos?',
                                respuesta: 'La ozonoterapia tiene tasas de éxito superiores al 90% en el tratamiento de fascitis plantar, con recuperación más rápida y menos efectos secundarios que tratamientos convencionales como corticoides.'
                            },
                            {
                                pregunta: '¿Qué puedo hacer para prevenir que vuelva?',
                                respuesta: 'Es importante mantener un peso saludable, usar calzado adecuado con buen soporte del arco, hacer estiramientos regulares de la fascia plantar, usar plantillas ortopédicas si es necesario, y evitar superficies duras durante períodos prolongados.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que la fascitis plantar limite tu vida. Agenda tu cita y vuelve a caminar sin dolor.
                    </p>
