...
export default function ArtrosisRodillaPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/artrosis/artrosis_rodilla.png"
                        alt="Tratamiento para Artrosis de Rodilla"
                        fill
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-16 max-w-7xl relative z-10 py-20">
                    <div className="mb-8">
                        <Breadcrumbs
                            items={[
                                ...
                                { label: 'Artrosis', href: '/tratamientos/dolor/artrosis' },
                                { label: 'Rodilla' }
                            ]}
                        />
                    </div>
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link href="/tratamientos/dolor/artrosis" className="border-2 border-white/30 backdrop-blur-md text-white hover:bg-white hover:text-corporate-blue px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 text-center hover:border-white">
                                Ver Otras Artrosis
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">artrosis de rodilla</strong> o gonartrosis es una de las formas más comunes de artrosis, causando desgaste del cartílago articular, dolor intenso, hinchazón, rigidez y dificultad para caminar o subir escaleras.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento altamente efectivo que regenera el cartílago, reduce la inflamación sinovial, alivia el dolor crónico y mejora dramáticamente la movilidad, evitando la necesidad de cirugía de reemplazo total de rodilla.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Desgaste natural por edad',
                                    'Sobrepeso y obesidad',
                                    'Lesiones previas de menisco',
                                    'Desalineación de rodillas (genu varo/valgo)',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio de la artrosis de rodilla
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Regenera el Cartílago',
                                description: 'Estimula la formación de nuevo cartílago articular'
                            },
                            {
                                icon: Activity,
                                title: 'Elimina la Rigidez',
                                description: 'Recupera la flexibilidad y el rango de movimiento'
                            },
                            {
                                icon: Heart,
                                title: 'Reduce la Hinchazón',
                                description: 'Disminuye el derrame articular y la inflamación'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Evita Prótesis de Rodilla',
                                description: 'Alternativa efectiva al reemplazo total de rodilla'
                            },
                            {
                                icon: Clock,
                                title: 'Alivio Progresivo',
                                description: 'Mejora continua con cada sesión del protocolo'
                            },
                            {
                                icon: Star,
                                title: 'Camina sin Dolor',
                                description: 'Recupera la capacidad de caminar cómodamente'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción significativa del dolor y mejora en la movilidad de la rodilla desde las primeras 3-4 sesiones, con disminución notable de la hinchazón y rigidez matutina.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 10-15 sesiones para artrosis de rodilla, con efectos que pueden durar de 8 a 12 meses o más, evitando o retrasando la necesidad de cirugía de reemplazo.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Procedimiento ambulatorio y seguro</li>
                                        <li>• Alternativa efectiva a la prótesis de rodilla</li>
                                        <li>• Mejora dramática en calidad de vida</li>
                                        <li>• Compatible con pérdida de peso y ejercicio</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. La aplicación intraarticular en la rodilla se realiza con agujas muy finas y la mayoría de los pacientes solo sienten una leve presión.'
                            },
                            {
                                pregunta: '¿Funciona para artrosis avanzada de rodilla?',
                                respuesta: 'Sí, la ozonoterapia es efectiva incluso en casos avanzados de artrosis de rodilla. Aunque los mejores resultados se obtienen en etapas tempranas, pacientes con artrosis severa también experimentan mejoras significativas en el dolor y la movilidad.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura cada sesión?',
                                respuesta: 'Cada sesión dura aproximadamente 30-40 minutos. Es un procedimiento ambulatorio y puedes caminar inmediatamente después, aunque se recomienda evitar ejercicios intensos ese día.'
                            },
                            {
                                pregunta: '¿Puedo evitar la cirugía de reemplazo de rodilla?',
                                respuesta: 'En muchos casos sí. La ozonoterapia ha demostrado evitar o retrasar significativamente la necesidad de prótesis de rodilla en más del 75% de los pacientes, especialmente cuando se inicia el tratamiento tempranamente.'
                            },
                            {
                                pregunta: '¿Cuándo podré subir escaleras sin dolor?',
                                respuesta: 'La mayoría de los pacientes experimentan mejora significativa para subir escaleras después de 4-6 sesiones. La recuperación es progresiva y continúa mejorando durante todo el tratamiento.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que la artrosis de rodilla te impida caminar. Agenda tu cita y evita la prótesis de rodilla.
                    </p>
