...
export default function ArtrosisCaderaPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/artrosis/artrosis_cadera.png"
                        alt="Tratamiento para Artrosis de Cadera"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">artrosis de cadera</strong> o coxartrosis es una enfermedad degenerativa que afecta la articulación coxofemoral, causando desgaste progresivo del cartílago, dolor intenso, rigidez y dificultad para caminar.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento revolucionario que regenera el cartílago articular, reduce la inflamación, alivia el dolor crónico y mejora significativamente la movilidad, evitando o retrasando la necesidad de cirugía de reemplazo total de cadera.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Desgaste natural por edad avanzada',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio de la artrosis de cadera
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Estimula la producción de nuevo cartílago articular'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora la Movilidad',
                                description: 'Recupera la capacidad de caminar sin dolor'
                            },
                            {
                                icon: Heart,
                                title: 'Alivia el Dolor Intenso',
                                description: 'Reduce significativamente el dolor crónico de cadera'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Evita Prótesis de Cadera',
                                description: 'Alternativa efectiva al reemplazo total de cadera'
                            },
                            {
                                icon: Clock,
                                title: 'Resultados Progresivos',
                                description: 'Mejora continua con cada sesión del tratamiento'
                            },
                            {
                                icon: Star,
                                title: 'Recupera tu Independencia',
                                description: 'Vuelve a caminar y realizar actividades sin ayuda'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción significativa del dolor y mejora en la movilidad de la cadera desde las primeras 4-6 sesiones, con recuperación progresiva de la capacidad de caminar sin cojera.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 12-20 sesiones para artrosis de cadera moderada a severa, con efectos que pueden durar de 10 a 18 meses, retrasando o evitando la cirugía de reemplazo.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Procedimiento no invasivo y seguro</li>
                                        <li>• Alternativa real a la prótesis de cadera</li>
                                        <li>• Mejora calidad de vida significativamente</li>
                                        <li>• Compatible con rehabilitación física</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">12-20</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Sesiones recomendadas</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">10-18</div>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. La aplicación intraarticular se realiza con técnicas avanzadas que minimizan cualquier molestia.'
                            },
                            {
                                pregunta: '¿Puede evitarse la prótesis de cadera con ozonoterapia?',
                                respuesta: 'En muchos casos sí. La ozonoterapia puede retrasar significativamente o evitar la necesidad de cirugía de reemplazo total de cadera, especialmente en etapas tempranas a moderadas de artrosis. Más del 70% de nuestros pacientes evitan la cirugía.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura cada sesión?',
                                respuesta: 'Cada sesión dura aproximadamente 30-45 minutos. Es un procedimiento ambulatorio y puedes caminar después del tratamiento, aunque se recomienda descanso relativo ese día.'
                            },
                            {
                                pregunta: '¿Funciona para artrosis severa?',
                                respuesta: 'Sí, incluso en casos severos la ozonoterapia puede proporcionar alivio significativo del dolor y mejorar la movilidad. Los mejores resultados se obtienen cuando se inicia el tratamiento tempranamente.'
                            },
                            {
                                pregunta: '¿Cuándo podré caminar sin dolor?',
                                respuesta: 'La mayoría de los pacientes experimentan reducción significativa del dolor después de 4-6 sesiones. La mejoría es progresiva y continúa durante todo el tratamiento y varios meses después.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que la artrosis de cadera te quite tu independencia. Agenda tu cita y evita la cirugía de reemplazo.
                    </p>
