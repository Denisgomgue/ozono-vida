        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/fibromialgia.png"
                        alt="Tratamiento para Fibromialgia"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">fibromialgia</strong> es una condición crónica caracterizada por dolor musculoesquelético generalizado, fatiga extrema, trastornos del sueño y sensibilidad aumentada al dolor.
                                </p>
                                <p>
                                    La ozonoterapia ha demostrado ser efectiva en el tratamiento de la fibromialgia, reduciendo el dolor, mejorando la calidad del sueño y aumentando los niveles de energía de forma significativa.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el manejo de la fibromialgia
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminución significativa del dolor muscular y articular'
                            },
                            {
                                icon: Activity,
                                title: 'Aumenta la Energía',
                                description: 'Mejora los niveles de energía y reduce la fatiga crónica'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora el Sueño',
                                description: 'Favorece un sueño reparador y de mejor calidad'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la inflamación sistémica del organismo'
                            },
                            {
                                icon: Clock,
                                title: 'Mejora la Función',
                                description: 'Incrementa la capacidad funcional en actividades diarias'
                            },
                            {
                                icon: Star,
                                title: 'Mejora la Calidad de Vida',
                                description: 'Recupera tu bienestar físico y emocional'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes con fibromialgia experimentan reducción del dolor y mejora en la calidad del sueño desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 15-20 sesiones iniciales, seguido de sesiones de mantenimiento mensuales para mantener los beneficios a largo plazo.
                                </p>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia cura la fibromialgia?',
                                respuesta: 'Si bien la fibromialgia no tiene cura definitiva, la ozonoterapia ayuda significativamente a controlar los síntomas, reducir el dolor y mejorar la calidad de vida de forma sostenida.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito?',
                                respuesta: 'Se recomiendan 15-20 sesiones iniciales realizadas 2-3 veces por semana, seguidas de sesiones de mantenimiento mensuales. El plan se ajusta según la respuesta de cada paciente.'
                            },
                            {
                                pregunta: '¿Puedo combinar la ozonoterapia con mis medicamentos?',
                                respuesta: 'Sí, la ozonoterapia es compatible con otros tratamientos. Muchos pacientes logran reducir gradualmente las dosis de medicamentos bajo supervisión médica.'
                            },
                            {
                                pregunta: '¿Cuándo veré resultados?',
                                respuesta: 'La mayoría de pacientes comienzan a notar mejoría en el dolor y los niveles de energía después de 4-6 semanas de tratamiento. Los resultados mejoran progresivamente con cada sesión.'
                            },
                            {
                                pregunta: '¿Qué otras terapias complementan el tratamiento?',
                                respuesta: 'Se recomienda combinar con ejercicio adaptado, fisioterapia, técnicas de manejo del estrés, buenos hábitos de sueño y una alimentación antiinflamatoria.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que la fibromialgia controle tu vida. Agenda tu cita y recupera tu bienestar.
                    </p>
