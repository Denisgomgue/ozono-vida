...
export default function EscoliosisPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/escoliosis.png"
                        alt="Tratamiento para Escoliosis"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">escoliosis</strong> es una desviación lateral de la columna vertebral que puede formar una curva en forma de &ldquo;S&rdquo; o &ldquo;C&rdquo;. Puede causar dolor, desequilibrio postural y limitaciones funcionales.
                                </p>
                                <p>
                                    La ozonoterapia, combinada con fisioterapia, ofrece un tratamiento efectivo para manejar el dolor asociado a la escoliosis, mejorar la movilidad y reducir la progresión de la curvatura.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    'Escoliosis degenerativa (adultos)',
                                    'Factores genéticos',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el manejo de la escoliosis
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Alivia el dolor asociado a la escoliosis de forma efectiva'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora la Movilidad',
                                description: 'Aumenta el rango de movimiento y la flexibilidad'
                            },
                            {
                                icon: Heart,
                                title: 'Relaja los Músculos',
                                description: 'Reduce la tensión muscular compensatoria'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la inflamación de tejidos y articulaciones'
                            },
                            {
                                icon: Clock,
                                title: 'Mejora la Postura',
                                description: 'Ayuda a mejorar la alineación y el equilibrio corporal'
                            },
                            {
                                icon: Star,
                                title: 'Mejora la Calidad de Vida',
                                description: 'Permite realizar actividades diarias con mayor comodidad'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción del dolor y mejora en la movilidad desde las primeras semanas de tratamiento, con mejoras sostenidas en la función y calidad de vida.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 10-15 sesiones combinado con fisioterapia y ejercicios específicos para resultados óptimos y mantenimiento a largo plazo.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Tratamiento complementario no invasivo</li>
                                        <li>• Compatible con fisioterapia y ortesis</li>
                                        <li>• Sin efectos secundarios</li>
                                        <li>• Mejora la adherencia al tratamiento integral</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Reducción del dolor reportada</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'La ozonoterapia no corrige la curvatura de la escoliosis, pero es muy efectiva para manejar el dolor, mejorar la movilidad y la calidad de vida. Debe combinarse con fisioterapia y ejercicios correctivos.'
                            },
                            {
                                pregunta: '¿A qué edad se puede iniciar el tratamiento?',
                                respuesta: 'El tratamiento se puede iniciar en adolescentes y adultos. En niños más pequeños, se debe evaluar cada caso individualmente. Es especialmente útil en escoliosis del adulto con dolor asociado.'
                            },
                            {
                                pregunta: '¿Necesitaré cirugía si hago ozonoterapia?',
                                respuesta: 'La ozonoterapia es un tratamiento complementario que ayuda a manejar síntomas, pero no sustituye la cirugía cuando esta está indicada en casos severos. Tu médico evaluará la necesidad de otros tratamientos.'
                            },
                            {
                                pregunta: '¿Puedo hacer ejercicio durante el tratamiento?',
                                respuesta: 'Sí, de hecho es muy recomendable. Los ejercicios específicos para escoliosis, natación, yoga y pilates complementan perfectamente el tratamiento con ozonoterapia.'
                            },
                            {
                                pregunta: '¿El tratamiento es permanente?',
                                respuesta: 'El alivio del dolor puede ser duradero, pero la escoliosis es una condición crónica que requiere seguimiento y mantenimiento. Se recomiendan sesiones periódicas y ejercicios continuos.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que la escoliosis limite tu vida. Agenda tu cita y mejora tu bienestar.
                    </p>
