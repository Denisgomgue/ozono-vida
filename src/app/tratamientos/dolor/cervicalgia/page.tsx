        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/cervicalgia.png"
                        alt="Tratamiento para Cervicalgia"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">cervicalgia</strong> es el dolor localizado en la región cervical o cuello, una de las molestias musculoesqueléticas más frecuentes en la actualidad debido al uso prolongado de dispositivos electrónicos y malas posturas.
                                </p>
                                <p>
                                    La ozonoterapia proporciona un tratamiento efectivo para la cervicalgia, reduciendo la tensión muscular, la inflamación y mejorando la movilidad del cuello de forma natural y sin efectos secundarios.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Malas posturas (ordenador, móvil)',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio de la cervicalgia
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Reducción significativa del dolor cervical desde las primeras sesiones'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora la Movilidad',
                                description: 'Recupera el rango de movimiento completo del cuello'
                            },
                            {
                                icon: Heart,
                                title: 'Relaja los Músculos',
                                description: 'Libera la tensión muscular acumulada en la zona cervical'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Sin Medicamentos',
                                description: 'Tratamiento natural sin efectos secundarios de analgésicos'
                            },
                            {
                                icon: Clock,
                            ...
                            },
                            {
                                ...
                                description: 'Evita que el dolor se vuelva crónico y genere otras molestias'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio del dolor cervical y mejora en la movilidad desde las primeras sesiones, con reducción significativa de la rigidez y tensión muscular.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 6-8 sesiones para resultados óptimos, con efectos que pueden durar varios meses cuando se mantienen buenos hábitos posturales.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Compatible con ergonomía y ejercicios</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">6-8</div>
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            },
                            {
                                ...
                                respuesta: 'Generalmente se recomiendan entre 6 y 8 sesiones, aunque esto puede variar según la severidad y cronicidad de la cervicalgia. Nuestro médico evaluará tu caso específico.'
                            },
                            {
                                pregunta: '¿Puedo trabajar después del tratamiento?',
                                respuesta: 'Sí, puedes retomar tus actividades laborales inmediatamente después de cada sesión. El tratamiento no requiere tiempo de recuperación.'
                            },
                            {
                                pregunta: '¿Qué ejercicios puedo hacer para complementar el tratamiento?',
                                respuesta: 'Se recomiendan ejercicios de estiramiento cervical, fortalecimiento de la musculatura del cuello y corrección postural. Nuestro equipo te puede guiar sobre los ejercicios más apropiados.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden ser duraderos si se mantienen buenos hábitos posturales, se realizan pausas activas y se evitan factores desencadenantes. Sesiones de mantenimiento pueden ayudar a prevenir recaídas.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor cervical afecte tu día a día. Agenda tu cita y recupera tu bienestar.
                    </p>
