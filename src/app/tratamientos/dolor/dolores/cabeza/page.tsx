...
export default function DolorCabezaPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_cabeza.png"
                        alt="Tratamiento para Dolor de Cabeza"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de cabeza</strong> o cefalea es una de las afecciones más comunes que afectan la calidad de vida. Puede manifestarse como migrañas, cefaleas tensionales o dolores crónicos que limitan las actividades diarias.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo para aliviar el dolor de cabeza, reduciendo la inflamación, mejorando la oxigenación cerebral y abordando las causas subyacentes del dolor.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio del dolor de cabeza
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye la inflamación de vasos sanguíneos y tejidos cerebrales'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora la Oxigenación',
                                description: 'Aumenta el flujo de oxígeno al cerebro, reduciendo el dolor'
                            },
                            {
                                icon: Heart,
                                title: 'Alivia la Tensión',
                                description: 'Relaja los músculos y reduce la tensión cervical'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Sin Efectos Secundarios',
                                description: 'Tratamiento natural sin los efectos adversos de medicamentos'
                            },
                            {
                                icon: Clock,
                                title: 'Resultados Duraderos',
                                description: 'Efectos prolongados que mejoran con cada sesión'
                            },
                            {
                                icon: Star,
                                title: 'Mejora la Calidad de Vida',
                                description: 'Recupera tu bienestar y actividades cotidianas'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio del dolor de cabeza desde las primeras sesiones, con mejoras progresivas en la frecuencia e intensidad de los episodios.
                                </p>
                                <p>
                                ...
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Complementario con otros tratamientos</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            },
                            {
                                ...
                                respuesta: 'Generalmente se recomiendan entre 6 y 10 sesiones, aunque esto puede variar según la severidad y frecuencia de los dolores de cabeza. Nuestro médico evaluará tu caso específico.'
                            },
                            {
                            ...
                            {
                                pregunta: '¿Puedo combinar este tratamiento con medicamentos?',
                                respuesta: 'Sí, la ozonoterapia es compatible con otros tratamientos médicos. De hecho, muchos pacientes logran reducir gradualmente su dependencia de medicamentos analgésicos.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden durar varios meses. Para mantener los beneficios a largo plazo, se pueden realizar sesiones de mantenimiento cada 3-6 meses.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor de cabeza controle tu vida. Agenda tu cita y recupera tu bienestar.
                    </p>
