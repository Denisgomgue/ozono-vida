...
export default function DolorRodillasPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_rodilla.png"
                        alt="Tratamiento para Dolor de Rodillas"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de rodillas</strong> es una afección común que puede deberse a artrosis, lesiones de meniscos, desgaste articular, o sobrecarga por actividades deportivas o laborales.
                                </p>
                                <p>
                                    La ozonoterapia es altamente efectiva para el dolor de rodilla, ya que reduce la inflamación, regenera el cartílago dañado y mejora la lubricación articular sin necesidad de cirugía.
                                </p>
                            </div>
                        </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Estimula la regeneración del tejido cartilaginoso dañado'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora la Lubricación',
                                description: 'Aumenta la producción de líquido sinovial para mejor movilidad'
                            },
                            {
                                icon: Heart,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la hinchazón y el dolor articular significativamente'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Evita Cirugía',
                                description: 'Alternativa efectiva sin necesidad de reemplazo articular'
                            },
                            {
                                icon: Clock,
                                title: 'Resultados Duraderos',
                                description: 'Alivio prolongado que mejora la calidad de vida'
                            },
                            {
                                icon: Star,
                                title: 'Mayor Movilidad',
                                description: 'Recupera la capacidad de caminar y realizar actividades sin dolor'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes con dolor de rodilla experimentan mejoras notables después de las primeras 3-5 sesiones, con reducción significativa del dolor y mejor movilidad.
                                </p>
                                <p>
                                    Para artrosis de rodilla, se recomienda un protocolo de 10-15 sesiones, con efectos que pueden durar 6-12 meses o más.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Alternativa efectiva a la cirugía de rodilla</li>
                                        <li>• Aplicación intraarticular precisa</li>
                                        <li>• Sin necesidad de prótesis</li>
                                        <li>• Recuperación rápida y ambulatoria</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede evitar una cirugía de rodilla?',
                                respuesta: 'En muchos casos sí. La ozonoterapia ha demostrado ser efectiva para tratar artrosis de rodilla y evitar o posponer la necesidad de reemplazo articular.'
                            },
                            {
                                pregunta: '¿El tratamiento es doloroso?',
                                respuesta: 'La aplicación intraarticular puede causar una leve molestia momentánea, pero es muy tolerable. Utilizamos técnicas para minimizar cualquier incomodidad.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito?',
                                respuesta: 'Para artrosis de rodilla, generalmente se recomiendan 10-15 sesiones. Para lesiones menores, pueden ser suficientes 6-8 sesiones.'
                            },
                            {
                                pregunta: '¿Puedo caminar después del tratamiento?',
                                respuesta: 'Sí, puedes caminar inmediatamente después. Se recomienda evitar esfuerzos intensos y deportes de impacto por 24-48 horas.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los efectos pueden durar de 6 a 12 meses o más. Para mantener los beneficios, se recomiendan sesiones de mantenimiento según evaluación médica.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor de rodillas limite tu movilidad. Agenda tu cita y recupera tu libertad de movimiento.
                    </p>
