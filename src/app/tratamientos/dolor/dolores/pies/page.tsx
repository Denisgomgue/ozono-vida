...
export default function DolorPiesPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_pie.png"
                        alt="Tratamiento para Dolor de Pies"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de pies</strong> puede afectar el arco plantar, talón, dedos o la parte superior del pie, siendo causado por fascitis plantar, espolón calcáneo, neuroma de Morton o problemas articulares.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo que reduce la inflamación plantar, alivia el dolor del espolón calcáneo, mejora la circulación y promueve la regeneración de tejidos dañados del pie.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio del dolor de pies
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Alivia la Fascitis Plantar',
                                description: 'Reduce la inflamación de la fascia plantar efectivamente'
                            },
                            {
                                icon: Activity,
                                title: 'Elimina el Espolón',
                                description: 'Trata el espolón calcáneo sin necesidad de cirugía'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora la Circulación',
                                description: 'Aumenta el flujo sanguíneo en el pie para mejor curación'
                            },
                            {
                                icon: CheckCircle,
                            ...
                            },
                            {
                                ...
                                description: 'Efectos prolongados con protocolo adecuado'
                            },
                            {
                                icon: Star,
                                title: 'Recupera tu Movilidad',
                                description: 'Vuelve a realizar tus actividades sin limitaciones'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio significativo del dolor en los pies desde las primeras 2-3 sesiones, con reducción notable del dolor al caminar y estar de pie.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 6-10 sesiones para fascitis plantar y espolón calcáneo, con efectos que pueden durar de 6 meses a un año.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Evita infiltraciones dolorosas</li>
                                        <li>• Puedes caminar inmediatamente después</li>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. La aplicación es rápida y la mayoría de los pacientes solo sienten una leve molestia momentánea.'
                            },
                            {
                                pregunta: '¿Es efectivo para la fascitis plantar?',
                                respuesta: 'Sí, es altamente efectivo. La ozonoterapia es uno de los mejores tratamientos para fascitis plantar, con tasas de éxito superiores al 85%. Reduce la inflamación y regenera la fascia dañada.'
                            },
                            {
                                pregunta: '¿Funciona para el espolón calcáneo?',
                                respuesta: 'Absolutamente. La ozonoterapia reduce el tamaño del espolón, alivia el dolor y la inflamación, evitando la necesidad de cirugía en la mayoría de los casos.'
                            },
                            {
                                pregunta: '¿Puedo caminar después del tratamiento?',
                                respuesta: 'Sí, puedes caminar inmediatamente después. Se recomienda usar calzado cómodo y evitar largas caminatas o estar de pie por períodos prolongados las primeras 24 horas.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden durar entre 6 meses y un año. Para mantener los beneficios, se recomienda usar calzado adecuado, mantener un peso saludable y realizar sesiones de mantenimiento si es necesario.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor de pies te detenga. Agenda tu cita y vuelve a caminar sin molestias.
                    </p>
