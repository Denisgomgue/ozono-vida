...
export default function DolorMusloPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_muslo.png"
                        alt="Tratamiento para Dolor de Muslo"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de muslo</strong> puede originarse por lesiones musculares, desgarros, contracturas, problemas de ciática o sobrecarga del cuádriceps y los isquiotibiales, afectando la capacidad de caminar y realizar actividades físicas.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo que acelera la recuperación de lesiones musculares, reduce la inflamación, mejora la circulación sanguínea y alivia el dolor de forma natural sin medicamentos.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio del dolor de muslo
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Recuperación Muscular Rápida',
                                description: 'Acelera la curación de desgarros y lesiones musculares'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la hinchazón y el edema muscular rápidamente'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora la Circulación',
                                description: 'Aumenta el flujo sanguíneo para una recuperación óptima'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Alivia Espasmos',
                                description: 'Relaja la musculatura y elimina las contracturas'
                            },
                            {
                                icon: Clock,
                                title: 'Regreso Rápido al Deporte',
                                description: 'Vuelve a tus actividades físicas en menos tiempo'
                            },
                            {
                                icon: Star,
                                title: 'Sin Medicamentos',
                                description: 'Tratamiento natural sin efectos secundarios'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio del dolor muscular y mejora en la movilidad desde las primeras 1-3 sesiones, con recuperación acelerada de desgarros y contracturas.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 5-10 sesiones para lesiones musculares, con efectos que pueden durar de 4 a 8 meses dependiendo del tipo de lesión.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Recuperación más rápida que el reposo solo</li>
                                        <li>• Sin necesidad de reposo absoluto</li>
                                        <li>• Compatible con fisioterapia deportiva</li>
                                        <li>• Previene lesiones recurrentes</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">1-3</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Sesiones para notar mejoría</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">5-10</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Sesiones recomendadas</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">4-8</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Meses de recuperación sostenida</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. La aplicación es rápida y la mayoría de los pacientes solo sienten una leve presión en el área tratada.'
                            },
                            {
                                pregunta: '¿Es efectivo para desgarros musculares?',
                                respuesta: 'Sí, es muy efectivo. La ozonoterapia acelera significativamente la recuperación de desgarros musculares, reduciendo el tiempo de recuperación hasta en un 50% comparado con el reposo solo.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura cada sesión?',
                                respuesta: 'Cada sesión dura aproximadamente 20-30 minutos. Es un procedimiento ambulatorio y puedes retomar tus actividades ligeras el mismo día.'
                            },
                            {
                                pregunta: '¿Puedo hacer ejercicio después del tratamiento?',
                                respuesta: 'Se recomienda esperar 24-48 horas antes de realizar ejercicios intensos. Puedes hacer actividades ligeras inmediatamente y progresivamente aumentar la intensidad según indicación médica.'
                            },
                            {
                                pregunta: '¿Previene futuras lesiones musculares?',
                                respuesta: 'Sí, la ozonoterapia fortalece los tejidos musculares y mejora su elasticidad, reduciendo el riesgo de lesiones recurrentes. Se recomienda combinar con estiramientos adecuados.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor muscular te detenga. Agenda tu cita y recupera tu rendimiento físico.
                    </p>
