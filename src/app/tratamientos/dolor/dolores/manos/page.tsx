...
export default function DolorManosPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_manos.png"
                        alt="Tratamiento para Dolor de Manos"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de manos</strong> puede ser causado por artritis, síndrome del túnel carpiano, tendinitis o artrosis de las articulaciones de los dedos, afectando significativamente las actividades diarias.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo que reduce la inflamación articular, mejora la movilidad de los dedos y regenera el cartílago dañado, permitiendo recuperar la funcionalidad completa de las manos.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio del dolor de manos
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye la hinchazón y el dolor en articulaciones de dedos'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora la Movilidad',
                                description: 'Recupera la flexibilidad y el rango de movimiento de los dedos'
                            },
                            {
                                icon: Heart,
                                title: 'Alivia el Túnel Carpiano',
                                description: 'Reduce la compresión del nervio mediano y el hormigueo'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Evita Cirugía',
                            ...
                            },
                            {
                                ...
                                description: 'Estimula la reparación natural del cartílago articular'
                            },
                            {
                                icon: Star,
                                title: 'Recupera tu Independencia',
                                description: 'Vuelve a realizar tus actividades cotidianas sin limitaciones'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción del dolor y mejora en la movilidad de las manos desde las primeras 2-4 sesiones, con recuperación progresiva de la fuerza de agarre.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 6-12 sesiones según la condición (artritis, túnel carpiano, etc.), con efectos que pueden durar de 6 meses a un año.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Evita cirugía de túnel carpiano</li>
                                        <li>• Regreso inmediato a actividades ligeras</li>
                                        <li>• Compatible con terapia ocupacional</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. Se utilizan agujas muy finas y la mayoría de los pacientes solo sienten una leve presión durante la aplicación.'
                            },
                            {
                                pregunta: '¿Es efectivo para el síndrome del túnel carpiano?',
                                respuesta: 'Sí, la ozonoterapia es muy efectiva para el túnel carpiano. Reduce la inflamación del nervio mediano, alivia el hormigueo y puede evitar la necesidad de cirugía en muchos casos.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura cada sesión?',
                                respuesta: 'Cada sesión dura aproximadamente 20-30 minutos. Es un procedimiento ambulatorio y puedes usar tus manos normalmente después del tratamiento.'
                            },
                            {
                                pregunta: '¿Funciona para la artritis de manos?',
                                respuesta: 'Absolutamente. La ozonoterapia es altamente efectiva para artritis reumatoide y artrosis de manos, reduciendo el dolor, la rigidez y mejorando la movilidad articular significativamente.'
                            },
                            {
                                pregunta: '¿Puedo trabajar después del tratamiento?',
                                respuesta: 'Sí, puedes retomar tus actividades normales inmediatamente. Se recomienda evitar esfuerzos intensos con las manos durante las primeras 24 horas para optimizar los resultados.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor de manos te limite. Agenda tu cita y recupera la funcionalidad completa de tus manos.
                    </p>
