...
export default function DolorPlantasPiesPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_planta_pie.png"
                        alt="Tratamiento para Dolor de Planta de Pies"
                        fill
            ...
            {/* ¿Qué es el Dolor de Planta del Pie? */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de planta del pie</strong> es principalmente causado por fascitis plantar, una inflamación de la banda de tejido que conecta el talón con los dedos. Es una de las causas más comunes de dolor en el talón y planta.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento altamente efectivo que reduce la inflamación de la fascia plantar, alivia el dolor del espolón calcáneo, mejora la elasticidad de los tejidos y acelera la recuperación sin necesidad de cirugía.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio del dolor plantar
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Elimina la Fascitis Plantar',
                                description: 'Tratamiento altamente efectivo para fascitis plantar crónica'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce el Espolón Calcáneo',
                                description: 'Disminuye el tamaño y el dolor del espolón sin cirugía'
                            },
                            {
                                icon: Heart,
                                title: 'Regenera la Fascia',
                                description: 'Estimula la curación y regeneración de tejidos dañados'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Camina sin Dolor',
                                description: 'Elimina el dolor al dar los primeros pasos de la mañana'
                            },
                            {
                                icon: Clock,
                                title: 'Recuperación Rápida',
                                description: 'Resultados visibles en pocas sesiones'
                            },
                            {
                                icon: Star,
                                title: 'Sin Cirugía',
                                description: 'Evita procedimientos quirúrgicos invasivos y dolorosos'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio significativo del dolor plantar desde las primeras 2-4 sesiones, con reducción notable del dolor matutino característico de la fascitis plantar.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 6-12 sesiones para fascitis plantar crónica o espolón calcáneo, con efectos que pueden durar de 8 meses a un año.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Tratamiento altamente efectivo (85% de éxito)</li>
                                        <li>• Evita cirugía de fascitis plantar</li>
                                        <li>• Sin necesidad de inmovilización</li>
                                        <li>• Compatible con plantillas ortopédicas</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. La aplicación es rápida y mucho menos dolorosa que las infiltraciones convencionales con corticoides.'
                            },
                            {
                                pregunta: '¿Es efectivo para la fascitis plantar crónica?',
                                respuesta: 'Sí, es altamente efectivo. La ozonoterapia es uno de los mejores tratamientos para fascitis plantar crónica, con tasas de éxito superiores al 85%, incluso en casos resistentes a otros tratamientos.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura cada sesión?',
                                respuesta: 'Cada sesión dura aproximadamente 20-30 minutos. Es un procedimiento ambulatorio y puedes caminar inmediatamente después, aunque se recomienda descanso relativo ese día.'
                            },
                            {
                                pregunta: '¿Puedo evitar la cirugía con este tratamiento?',
                                respuesta: 'En la mayoría de los casos sí. La ozonoterapia evita la necesidad de cirugía de fascitis plantar en más del 90% de los casos, ofreciendo una alternativa segura y efectiva.'
                            },
                            {
                                pregunta: '¿Necesito usar plantillas ortopédicas?',
                                respuesta: 'Se recomienda complementar el tratamiento con plantillas ortopédicas personalizadas para corregir problemas biomecánicos y mantener los resultados a largo plazo.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que la fascitis plantar limite tu vida. Agenda tu cita y camina sin dolor desde el primer paso.
                    </p>
