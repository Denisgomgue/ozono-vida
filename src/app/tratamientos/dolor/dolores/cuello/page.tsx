...
export default function DolorCuelloPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_cuello.png"
                        alt="Tratamiento para Dolor de Cuello"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de cuello</strong> o cervicalgia es una molestia común causada por tensión muscular, mala postura, lesiones o problemas degenerativos en las vértebras cervicales.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un alivio efectivo al reducir la inflamación, relajar los músculos tensos y mejorar la circulación en la zona cervical, tratando tanto el dolor agudo como crónico.
                                </p>
                            </div>
                        </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye la inflamación en músculos y articulaciones cervicales'
                            },
                            {
                                icon: Activity,
                                title: 'Relaja la Musculatura',
                                description: 'Alivia la tensión muscular y los espasmos en el cuello'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora la Movilidad',
                                description: 'Recupera el rango de movimiento cervical completo'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Sin Cirugía',
                            ...
                            },
                            {
                                ...
                                description: 'Mejora continua del dolor con cada sesión'
                            },
                            {
                                icon: Star,
                                title: 'Previene Recaídas',
                                description: 'Fortalece la zona para evitar futuros episodios de dolor'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La mayoría de pacientes experimentan alivio significativo del dolor cervical tras las primeras sesiones, con mejora progresiva en la movilidad y reducción de la rigidez.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 8-12 sesiones para dolor crónico, con efectos duraderos que pueden extenderse por varios meses.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Procedimiento ambulatorio de 30-40 minutos</li>
                                        <li>• No requiere reposo posterior</li>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿El tratamiento es efectivo para dolor cervical crónico?',
                                respuesta: 'Sí, la ozonoterapia es especialmente efectiva para dolor cervical crónico, ya que trata la inflamación y promueve la regeneración de tejidos dañados.'
                            },
                            {
                                pregunta: '¿Puedo combinar este tratamiento con fisioterapia?',
                                respuesta: 'Absolutamente. De hecho, combinar ozonoterapia con fisioterapia potencia los resultados y acelera la recuperación.'
                            },
                            {
                                pregunta: '¿Cuánto dura cada sesión?',
                                respuesta: 'Cada sesión dura aproximadamente 30-40 minutos. El procedimiento es ambulatorio y puedes retomar tus actividades inmediatamente.'
                            },
                            {
                                pregunta: '¿Necesito reposo después del tratamiento?',
                                respuesta: 'No es necesario reposo. Puedes continuar con tus actividades normales después de cada sesión, aunque se recomienda evitar esfuerzos excesivos el mismo día.'
                            },
                            {
                                pregunta: '¿Cuándo veré resultados?',
                                respuesta: 'Muchos pacientes experimentan alivio después de las primeras 2-4 sesiones, con mejoras progresivas en la movilidad y reducción del dolor.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-cyan-50 drop-shadow-lg">
                        Recupera la Movilidad de tu Cuello
                    </h2>
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor cervical limite tu vida. Agenda tu cita y vuelve a moverte sin restricciones.
                    </p>
