        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/dolor-cuerpo/dolor_cadera.png"
                        alt="Tratamiento para Dolor de Cadera"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">dolor de cadera</strong> es una afección común que puede afectar significativamente la movilidad y calidad de vida. Puede originarse por artrosis, bursitis, artritis o lesiones en la articulación coxofemoral.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo y no invasivo para aliviar el dolor de cadera, reduciendo la inflamación, regenerando el cartílago y mejorando la función articular sin necesidad de cirugía.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio del dolor de cadera
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye la inflamación de la articulación y tejidos periarticulares'
                            },
                            {
                                icon: Activity,
                                title: 'Regeneración del Cartílago',
                                description: 'Estimula la regeneración del cartílago articular dañado'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora la Movilidad',
                                description: 'Aumenta el rango de movimiento y la flexibilidad de la cadera'
                            },
                            {
                                icon: CheckCircle,
                            ...
                            },
                            {
                                ...
                                description: 'Vuelve a realizar tus actividades cotidianas sin dolor'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio del dolor de cadera desde las primeras sesiones, con mejoras progresivas en la movilidad y reducción de la rigidez articular.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 8-12 sesiones para resultados óptimos en casos de artrosis de cadera, con efectos que pueden durar de 6 meses a un año.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Alternativa a la cirugía de reemplazo</li>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. La aplicación se realiza con agujas muy finas y algunos pacientes pueden sentir una ligera presión, pero es mínima y temporal.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito para la artrosis de cadera?',
                                respuesta: 'Para casos de artrosis de cadera se recomiendan entre 8 y 12 sesiones, aunque esto puede variar según la severidad. Nuestro médico evaluará tu caso específico y diseñará un plan personalizado.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura cada sesión?',
                                respuesta: 'Cada sesión de tratamiento dura aproximadamente 30-45 minutos. Es un procedimiento ambulatorio y puedes retomar tus actividades normales el mismo día.'
                            },
                            {
                                pregunta: '¿Puedo evitar la cirugía de reemplazo de cadera?',
                                respuesta: 'En muchos casos, la ozonoterapia puede retrasar o evitar la necesidad de cirugía de reemplazo de cadera, especialmente en etapas tempranas a moderadas de artrosis. Los resultados varían según cada paciente.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden durar entre 6 meses y un año. Para mantener los beneficios a largo plazo, se pueden realizar sesiones de mantenimiento cada 4-6 meses según la evolución del paciente.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor de cadera limite tu vida. Agenda tu cita y recupera tu movilidad.
                    </p>
