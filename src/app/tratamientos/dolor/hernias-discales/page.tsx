...
export default function HerniasDiscalesPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/hernias_discales.png"
                        alt="Tratamiento para Hernias Discales"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Una <strong className="text-corporate-blue">hernia discal</strong> ocurre cuando el núcleo gelatinoso de un disco intervertebral se sale de su lugar y presiona los nervios cercanos, causando dolor intenso, debilidad y limitación en el movimiento.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo y no invasivo para las hernias discales, reduciendo la inflamación, aliviando la presión sobre los nervios y promoviendo la regeneración del disco.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio de las hernias discales
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Alternativa efectiva a la cirugía sin riesgos quirúrgicos'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la inflamación del disco y los tejidos circundantes'
                            },
                            {
                                icon: Heart,
                                title: 'Alivia el Dolor',
                                description: 'Reduce significativamente el dolor y mejora la movilidad'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Regenera el Disco',
                                description: 'Estimula la regeneración natural del tejido discal'
                            },
                            {
                                icon: Clock,
                                title: 'Recuperación Rápida',
                                description: 'Sin tiempo de hospitalización ni recuperación prolongada'
                            },
                            {
                                icon: Star,
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan una reducción significativa del dolor desde las primeras sesiones, con mejoras progresivas en la movilidad y función de la columna.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 8-12 sesiones para resultados óptimos, con efectos que pueden ser permanentes cuando se combina con hábitos saludables.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Sin necesidad de anestesia general</li>
                                        <li>• Regreso inmediato a actividades</li>
                                        <li>• Evita riesgos de procedimientos invasivos</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿El tratamiento con ozono puede evitar la cirugía?',
                                respuesta: 'En muchos casos sí. La ozonoterapia ha demostrado ser efectiva para tratar hernias discales sin necesidad de cirugía, especialmente en casos leves a moderados. Sin embargo, cada caso debe ser evaluado individualmente.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito para ver resultados?',
                                respuesta: 'Generalmente se recomiendan entre 8 y 12 sesiones. Muchos pacientes comienzan a notar mejoría desde las primeras 2-4 sesiones, pero el protocolo completo es necesario para resultados duraderos.'
                            },
                            {
                                pregunta: '¿El tratamiento es doloroso?',
                                respuesta: 'El procedimiento es mínimamente invasivo y prácticamente indoloro. Se utiliza anestesia local en el punto de aplicación, causando solo una leve molestia temporal.'
                            },
                            {
                                pregunta: '¿Puedo combinar este tratamiento con otros?',
                                respuesta: 'Sí, la ozonoterapia es compatible con otros tratamientos como fisioterapia, medicamentos y ejercicios de rehabilitación. De hecho, la combinación suele potenciar los resultados.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden ser duraderos e incluso permanentes cuando se mantienen hábitos saludables, ejercicio regular y una buena postura. Algunos pacientes optan por sesiones de mantenimiento.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que la hernia discal limite tu vida. Agenda tu cita y recupera tu movilidad.
                    </p>
