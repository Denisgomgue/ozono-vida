...
export default function LumbalgiaPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/lumbalgia.png"
                        alt="Tratamiento para Lumbalgia"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">lumbalgia</strong> es el dolor localizado en la parte baja de la espalda, siendo una de las causas más comunes de discapacidad laboral. Puede ser aguda o crónica y limitar significativamente las actividades diarias.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento efectivo para la lumbalgia, reduciendo la inflamación, aliviando el dolor y mejorando la función de la columna vertebral sin necesidad de cirugía.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    'Dolor irradiado a glúteos o piernas'
                                ].map((sintoma, index) => (
                                    <div key={index} className="flex items-start space-x-3">
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para el alivio de la lumbalgia
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Reducción significativa del dolor lumbar desde las primeras sesiones'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora la Movilidad',
                                description: 'Recupera el rango de movimiento y la flexibilidad de la espalda'
                            },
                            {
                                icon: Heart,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la inflamación de músculos y tejidos lumbares'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Sin Cirugía',
                            ...
                            },
                            {
                                ...
                                description: 'Fortalece la zona y previene futuros episodios de dolor'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio del dolor lumbar desde las primeras sesiones, con mejoras progresivas en la movilidad y reducción de episodios dolorosos.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 6-10 sesiones para resultados óptimos, con efectos que pueden durar varios meses.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Sin necesidad de hospitalización</li>
                                        <li>• Regreso inmediato a actividades</li>
                                        <li>• Compatible con fisioterapia y ejercicio</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Efectividad en pacientes</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        {[
                            {
                                ...
                                respuesta: 'No, el tratamiento con ozonoterapia es prácticamente indoloro. Algunos pacientes pueden sentir una ligera molestia en el punto de aplicación, pero es mínima y temporal.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito?',
                                respuesta: 'Generalmente se recomiendan entre 6 y 10 sesiones, aunque esto puede variar según la severidad y cronicidad de la lumbalgia. Nuestro médico evaluará tu caso específico.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura cada sesión?',
                                respuesta: 'Cada sesión de tratamiento dura aproximadamente 30-45 minutos, y puedes retomar tus actividades normales inmediatamente después.'
                            },
                            {
                                pregunta: '¿Puedo hacer ejercicio durante el tratamiento?',
                                respuesta: 'Sí, de hecho se recomienda continuar con actividad física moderada y ejercicios de fortalecimiento. El tratamiento complementa perfectamente la fisioterapia y el ejercicio terapéutico.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden ser duraderos si se mantienen buenos hábitos posturales, ejercicio regular y peso saludable. Algunos pacientes optan por sesiones de mantenimiento preventivas.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que el dolor lumbar limite tu vida. Agenda tu cita y recupera tu bienestar.
                    </p>
