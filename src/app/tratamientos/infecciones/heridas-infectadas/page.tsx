...
export default function HeridasInfectadasPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/infecciones/heridas_infectadas.png"
                        alt="Tratamiento para Heridas Infectadas"
                        fill
            ...
            {/* ¿Qué son las Heridas Infectadas? */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Las <strong className="text-corporate-blue">heridas infectadas</strong> son lesiones de la piel donde bacterias u otros microorganismos han invadido el tejido, retrasando la cicatrización y causando inflamación, dolor y potenciales complicaciones graves.
                                </p>
                                <p>
                                    La ozonoterapia es altamente efectiva para tratar heridas infectadas, eliminando bacterias, hongos y virus, promoviendo la cicatrización y acelerando dramáticamente el proceso de sanación sin antibióticos sistémicos.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento elimina infecciones y acelera la cicatrización
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Elimina Bacterias',
                                description: 'Efecto bactericida potente contra todo tipo de gérmenes'
                            },
                            {
                                icon: Activity,
                                title: 'Acelera Cicatrización',
                                description: 'Promueve la regeneración rápida del tejido'
                            },
                            {
                                icon: Heart,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye hinchazón, enrojecimiento y dolor'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Mejora Oxigenación',
                                description: 'Aumenta el flujo de oxígeno a los tejidos dañados'
                            },
                            {
                                icon: Clock,
                                title: 'Sin Antibióticos Sistémicos',
                                description: 'Tratamiento local sin efectos secundarios de antibióticos'
                            },
                            {
                                icon: Star,
                                title: 'Previene Complicaciones',
                                description: 'Evita propagación de infección y complicaciones graves'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan control de la infección y mejoría visible de la herida desde las primeras sesiones, con reducción del dolor, inflamación y secreción.
                                </p>
                                <p>
                                    El número de sesiones varía según el tamaño y severidad de la herida (5-15 sesiones típicamente). La mayoría de heridas infectadas cicatrizan completamente con el protocolo adecuado.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Efecto bactericida inmediato</li>
                                        <li>• Sin resistencia antibiótica</li>
                                        <li>• Tratamiento ambulatorio rápido</li>
                                        <li>• Compatible con antibióticos si es necesario</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Sesiones para control de infección</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">5-15</div>
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Tasa de cicatrización exitosa</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede eliminar infecciones resistentes?',
                                respuesta: 'Sí, la ozonoterapia es efectiva incluso contra bacterias resistentes a antibióticos (superbacterias). El ozono actúa directamente oxidando las membranas bacterianas, evitando resistencia.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo tarda en controlarse la infección?',
                                respuesta: 'La mayoría de infecciones muestran mejoría significativa después de 1-2 sesiones. Los signos de infección (dolor, pus, enrojecimiento) comienzan a disminuir en 24-48 horas.'
                            },
                            {
                                pregunta: '¿Es doloroso el tratamiento?',
                                respuesta: 'No, el tratamiento es prácticamente indoloro. De hecho, alivia el dolor asociado a la infección desde las primeras aplicaciones.'
                            },
                            {
                                pregunta: '¿Puedo combinar con antibióticos?',
                                respuesta: 'Sí, la ozonoterapia es compatible con antibióticos y puede potenciar su efectividad. En muchos casos, permite reducir la dosis o duración de antibióticos.'
                            },
                            {
                                pregunta: '¿Qué tipo de heridas infectadas se pueden tratar?',
                                respuesta: 'Se pueden tratar todo tipo de heridas infectadas: quirúrgicas, traumáticas, por quemaduras, úlceras, abscesos, y heridas de difícil cicatrización.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Elimina la infección y sana tu herida de forma efectiva. Agenda tu cita ahora.
                    </p>
