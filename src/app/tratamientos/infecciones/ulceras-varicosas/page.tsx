...
export default function UlcerasVaricosasPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/infecciones/ulceras_varicosas_infecciones.png"
                        alt="Tratamiento para Úlceras Varicosas"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Las <strong className="text-corporate-blue">úlceras varicosas</strong> son heridas crónicas que se desarrollan en las piernas debido a insuficiencia venosa crónica, generalmente cerca de los tobillos. Son dolorosas y tienen alto riesgo de infección y complicaciones.
                                </p>
                                <p>
                                    La ozonoterapia es el tratamiento de elección para úlceras varicosas, mejorando dramáticamente la circulación venosa, eliminando infecciones, acelerando la cicatrización y previniendo recurrencias.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Herida abierta que no cicatriza',
                                    'Dolor intenso en la zona',
                                    'Hinchazón de piernas y tobillos',
                                    'Piel oscurecida alrededor',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            El tratamiento más efectivo para cicatrización de úlceras varicosas
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Controla y elimina bacterias en la úlcera'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora Circulación',
                                description: 'Optimiza el retorno venoso y flujo arterial'
                            },
                            {
                                icon: Heart,
                                title: 'Acelera Cicatrización',
                                description: 'Cierra úlceras resistentes a otros tratamientos'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce el Dolor',
                                description: 'Alivia significativamente el dolor de la úlcera'
                            },
                            {
                                icon: Clock,
                                title: 'Oxigena Tejidos',
                                description: 'Mejora la oxigenación de tejidos mal irrigados'
                            },
                            {
                                icon: Star,
                                title: 'Previene Recurrencias',
                                description: 'Reduce el riesgo de nuevas úlceras'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción significativa del tamaño de la úlcera, control de infecciones y alivio del dolor desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 12-20 sesiones según el tamaño de la úlcera. Debe combinarse con medias de compresión y elevación de piernas para mejores resultados.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Cicatrización de úlceras rebeldes</li>
                                        <li>• Sin cirugía ni injertos</li>
                                        <li>• Mejora calidad de vida</li>
                                        <li>• Reduce hospitalizaciones</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Semanas para ver cicatrización</div>
                                </div>
                                <div className="text-center">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Tasa de cicatrización completa</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede cerrar úlceras que llevan años abiertas?',
                                respuesta: 'Sí, la ozonoterapia ha demostrado cerrar úlceras varicosas que han estado abiertas por meses o incluso años. Es uno de los tratamientos más efectivos para estas heridas crónicas.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo tarda en cicatrizar?',
                                respuesta: 'Depende del tamaño de la úlcera. Úlceras pequeñas pueden cerrar en 4-8 semanas, mientras que úlceras grandes pueden requerir 2-4 meses de tratamiento.'
                            },
                            {
                                pregunta: '¿Necesito usar medias de compresión?',
                                respuesta: 'Sí, las medias de compresión son fundamentales para mejorar el retorno venoso y complementar el tratamiento con ozonoterapia. Su uso es esencial para prevenir recurrencias.'
                            },
                            {
                                pregunta: '¿El tratamiento previene que vuelvan a aparecer?',
                                respuesta: 'La ozonoterapia mejora la circulación venosa a largo plazo. Con uso de medias de compresión, elevación de piernas, ejercicio y sesiones de mantenimiento, se reduce significativamente el riesgo de recurrencia.'
                            },
                            {
                                pregunta: '¿Es mejor que los injertos de piel?',
                                respuesta: 'En muchos casos sí. La ozonoterapia permite cicatrización sin necesidad de injertos, evitando cirugías y hospitalizaciones. Es la primera opción de tratamiento en la mayoría de casos.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Sana tu úlcera y recupera tu movilidad. Agenda tu cita y mejora tu calidad de vida.
                    </p>
