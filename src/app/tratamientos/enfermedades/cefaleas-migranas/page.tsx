...
export default function CefaleasMigranasPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/cefaleas_migrañas.png"
                        alt="Tratamiento para Cefaleas y Migrañas"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Las <strong className="text-corporate-blue">cefaleas y migrañas</strong> son dolores de cabeza recurrentes que pueden ser debilitantes. Las migrañas son un tipo específico de cefalea caracterizada por dolor pulsátil intenso, náuseas y sensibilidad a la luz.
                                </p>
                                <p>
                                    La ozonoterapia ha demostrado alta efectividad en el tratamiento de cefaleas y migrañas, reduciendo la frecuencia e intensidad de los episodios, mejorando la oxigenación cerebral y aliviando los síntomas.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece alivio efectivo de cefaleas y migrañas
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Reduce Frecuencia',
                                description: 'Disminuye significativamente el número de episodios'
                            },
                            {
                                icon: Activity,
                                title: 'Mejora Oxigenación',
                                description: 'Aumenta el flujo de oxígeno al cerebro'
                            },
                            {
                                icon: Heart,
                                title: 'Alivia el Dolor',
                                description: 'Reduce la intensidad de los dolores de cabeza'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce Inflamación',
                                description: 'Disminuye la inflamación de vasos sanguíneos cerebrales'
                            },
                            {
                                icon: Clock,
                                title: 'Previene Episodios',
                                description: 'Tratamiento preventivo efectivo a largo plazo'
                            },
                            {
                                icon: Star,
                                title: 'Menos Medicamentos',
                                description: 'Reduce la dependencia de analgésicos y triptanes'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción significativa en la frecuencia e intensidad de cefaleas y migrañas desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 10-15 sesiones para resultados óptimos, con sesiones de mantenimiento cada 2-3 meses para prevención a largo plazo. Muchos pacientes logran eliminar o reducir drásticamente los episodios.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Tratamiento preventivo efectivo</li>
                                        <li>• Sin efectos secundarios de medicamentos</li>
                                        <li>• Mejora calidad de vida significativamente</li>
                                        <li>• Reduce ausentismo laboral</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Reducción de episodios</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede eliminar completamente las migrañas?',
                                respuesta: 'Muchos pacientes logran eliminar o reducir drásticamente los episodios de migraña. La efectividad varía según cada persona, pero la mayoría experimenta mejoras significativas en frecuencia e intensidad.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo tarda en hacer efecto?',
                                respuesta: 'La mayoría de pacientes comienzan a notar reducción en la frecuencia de episodios después de 2-4 semanas de tratamiento regular. Los resultados mejoran progresivamente.'
                            },
                            {
                                pregunta: '¿Puedo usarlo durante una crisis de migraña?',
                                respuesta: 'Sí, la ozonoterapia puede ayudar a aliviar un episodio agudo de migraña. Sin embargo, su mayor beneficio es como tratamiento preventivo regular.'
                            },
                            {
                                pregunta: '¿Puedo dejar mis medicamentos preventivos?',
                                respuesta: 'Muchos pacientes logran reducir o eliminar medicamentos preventivos gradualmente bajo supervisión médica. Es importante hacer cualquier cambio de medicación solo con aprobación de su neurólogo.'
                            },
                            {
                                pregunta: '¿Qué más puedo hacer para prevenir migrañas?',
                                respuesta: 'Es importante mantener horarios regulares de sueño, evitar alimentos desencadenantes, manejar el estrés, hacer ejercicio regular y mantenerse hidratado. El tratamiento funciona mejor con buenos hábitos.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        No dejes que las migrañas controlen tu vida. Agenda tu cita y recupera tu bienestar.
                    </p>
