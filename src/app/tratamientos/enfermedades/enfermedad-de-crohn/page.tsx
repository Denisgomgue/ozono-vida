...
export default function EnfermedadCrohnPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/enferemedad_crohn.png"
                        alt="Tratamiento para Enfermedad de Crohn"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">enfermedad de Crohn</strong> es una enfermedad inflamatoria intestinal crónica que puede afectar cualquier parte del tracto digestivo, causando inflamación profunda, dolor abdominal y complicaciones graves.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento complementario efectivo para la enfermedad de Crohn, reduciendo la inflamación intestinal, modulando la respuesta autoinmune y mejorando significativamente la calidad de vida.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento complementario ayuda a controlar la enfermedad
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye significativamente la inflamación intestinal crónica'
                            },
                            {
                                icon: Activity,
                                title: 'Modula Inmunidad',
                                description: 'Regula la respuesta autoinmune del organismo'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora Cicatrización',
                                description: 'Favorece la curación de lesiones y fístulas intestinales'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce Síntomas',
                                description: 'Disminuye dolor, diarrea y otros síntomas digestivos'
                            },
                            {
                                icon: Clock,
                                title: 'Previene Brotes',
                                description: 'Reduce la frecuencia e intensidad de las recaídas'
                            },
                            {
                                icon: Star,
                                title: 'Mejora Absorción',
                                description: 'Optimiza la absorción de nutrientes y reduce desnutrición'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción significativa de síntomas, mejor control de brotes y mejora en la calidad de vida desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo inicial de 15-25 sesiones, seguido de sesiones de mantenimiento mensuales. Debe combinarse con tratamiento médico convencional, dieta específica y manejo del estrés.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Complementa terapias biológicas</li>
                                        <li>• Reduce necesidad de cirugías</li>
                                        <li>• Sin efectos secundarios graves</li>
                                        <li>• Mejora respuesta a otros tratamientos</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">15-25</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Sesiones recomendadas</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">65%</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Reducción de síntomas</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede curar la enfermedad de Crohn?',
                                respuesta: 'La enfermedad de Crohn no tiene cura, pero la ozonoterapia es un tratamiento complementario muy efectivo que ayuda a controlar los síntomas, reducir brotes y mejorar significativamente la calidad de vida.'
                            },
                            {
                                pregunta: '¿Puedo dejar mis medicamentos biológicos?',
                                respuesta: 'No. La ozonoterapia complementa el tratamiento médico convencional, incluidos los biológicos, no los reemplaza. Cualquier cambio en medicación debe ser autorizado solo por su gastroenterólogo.'
                            },
                            {
                                pregunta: '¿El tratamiento ayuda con las fístulas?',
                                respuesta: 'Sí, la ozonoterapia puede ayudar significativamente en la cicatrización de fístulas y en la reducción de inflamación que las produce.'
                            },
                            {
                                pregunta: '¿Cuándo veré resultados?',
                                respuesta: 'La mayoría de pacientes comienzan a notar mejoras en 4-6 semanas, con reducción del dolor, menos diarrea y mejor bienestar general.'
                            },
                            {
                                pregunta: '¿Debo seguir una dieta especial?',
                                respuesta: 'Sí, es importante seguir una dieta antiinflamatoria y evitar alimentos desencadenantes. Nuestro equipo puede orientarte sobre nutrición adecuada para la enfermedad de Crohn.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Controla tu enfermedad y mejora tu calidad de vida. Agenda tu cita y recupera tu bienestar.
                    </p>
