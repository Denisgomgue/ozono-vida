        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/hepatitis_cronica.png"
                        alt="Tratamiento para Hepatitis Crónica"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">hepatitis crónica</strong> es una inflamación del hígado que dura más de seis meses, causada principalmente por virus (B o C), que puede llevar a cirrosis y cáncer de hígado si no se trata adecuadamente.
                                </p>
                                <p>
                                    La ozonoterapia ha demostrado ser efectiva como tratamiento complementario en hepatitis crónica, mejorando la función hepática, reduciendo la carga viral y potenciando la respuesta del sistema inmunológico.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento complementario ofrece múltiples beneficios para la función hepática
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Mejora Función Hepática',
                                description: 'Optimiza el funcionamiento del hígado y reduce enzimas elevadas'
                            },
                            {
                                icon: Activity,
                                title: 'Efecto Antiviral',
                                description: 'Ayuda a reducir la carga viral en hepatitis virales'
                            },
                            {
                                icon: Heart,
                                title: 'Fortalece Inmunidad',
                                description: 'Potencia el sistema inmunológico para combatir la infección'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce Inflamación',
                                description: 'Disminuye la inflamación hepática crónica'
                            },
                            {
                                icon: Clock,
                                title: 'Previene Progresión',
                                description: 'Ayuda a prevenir el avance hacia cirrosis'
                            },
                            {
                                icon: Star,
                                title: 'Mejora Calidad de Vida',
                                description: 'Reduce fatiga y mejora el bienestar general'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan mejoras en la función hepática, reducción de enzimas elevadas y disminución de la fatiga desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 20-30 sesiones iniciales como complemento al tratamiento médico convencional, con sesiones de mantenimiento periódicas según evolución.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Complementa tratamiento antiviral</li>
                                        <li>• Sin efectos hepatotóxicos</li>
                                        <li>• Mejora respuesta inmunológica</li>
                                        <li>• Reduce progresión de la enfermedad</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">20-30</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Sesiones recomendadas</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">75%</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Mejora en función hepática</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede curar la hepatitis crónica?',
                                respuesta: 'La ozonoterapia no cura la hepatitis crónica, pero es un tratamiento complementario muy efectivo que mejora la función hepática, reduce la carga viral y ayuda a prevenir la progresión de la enfermedad.'
                            },
                            {
                                pregunta: '¿Puedo dejar mi tratamiento antiviral?',
                                respuesta: 'No. La ozonoterapia complementa el tratamiento médico convencional, nunca lo reemplaza. Cualquier cambio en su medicación debe ser indicado únicamente por su hepatólogo.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito?',
                                respuesta: 'Se recomiendan 20-30 sesiones iniciales realizadas 2-3 veces por semana. Luego sesiones de mantenimiento según evolución de enzimas hepáticas y carga viral.'
                            },
                            {
                                pregunta: '¿El tratamiento tiene efectos secundarios?',
                                respuesta: 'La ozonoterapia es muy segura y no tiene efectos hepatotóxicos. A diferencia de muchos medicamentos, no sobrecarga el hígado y ayuda a su regeneración.'
                            },
                            {
                                pregunta: '¿Es efectiva para hepatitis B y C?',
                                respuesta: 'Sí, la ozonoterapia ha demostrado beneficios tanto en hepatitis B como C, ayudando a reducir la carga viral y mejorar la función hepática en ambos casos.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Mejora tu función hepática y calidad de vida. Agenda tu cita y recupera tu bienestar.
                    </p>
