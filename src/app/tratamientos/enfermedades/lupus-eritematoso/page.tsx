...
export default function LupusEritematosoPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/lupus_eritematoso_sistemico.png"
                        alt="Tratamiento para Lupus Eritematoso"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    El <strong className="text-corporate-blue">lupus eritematoso sistémico</strong> es una enfermedad autoinmune crónica donde el sistema inmunológico ataca los propios tejidos del cuerpo, causando inflamación y daño en articulaciones, piel, riñones y otros órganos.
                                </p>
                                <p>
                                    La ozonoterapia es un tratamiento complementario efectivo para el lupus, modulando la respuesta inmunológica, reduciendo la inflamación y mejorando significativamente la calidad de vida de los pacientes.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento complementario ayuda a controlar los síntomas del lupus
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Ayuda a regular la respuesta autoinmune del organismo'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la inflamación sistémica y articular'
                            },
                            {
                                icon: Heart,
                                title: 'Alivia el Dolor',
                                description: 'Reduce el dolor articular y muscular significativamente'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Aumenta Energía',
                                description: 'Reduce la fatiga crónica y mejora vitalidad'
                            },
                            {
                                icon: Clock,
                                title: 'Reduce Brotes',
                            ...
                            },
                            {
                                ...
                                description: 'Permite llevar una vida más activa y normal'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes con lupus experimentan reducción del dolor, mejora en la fatiga y disminución de la actividad de la enfermedad desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo inicial de 20-30 sesiones como complemento al tratamiento inmunsupresor, con sesiones de mantenimiento mensuales. Es fundamental el seguimiento médico continuo.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Complementa inmunosupresores</li>
                                        <li>• Reduce dosis de corticoides</li>
                                        <li>• Mejora respuesta inmunológica</li>
                                        <li>• Sin efectos inmunosupresores adicionales</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">60%</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Reducción en actividad de enfermedad</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede curar el lupus?',
                                respuesta: 'El lupus no tiene cura, pero la ozonoterapia es un tratamiento complementario muy efectivo que ayuda a controlar los síntomas, reducir brotes y mejorar significativamente la calidad de vida de los pacientes.'
                            },
                            {
                                pregunta: '¿Puedo dejar mis inmunosupresores?',
                                respuesta: 'No. La ozonoterapia complementa el tratamiento médico convencional, nunca lo reemplaza. Cualquier cambio en inmunosupresores debe ser autorizado únicamente por su reumatólogo.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito?',
                                respuesta: 'Se recomiendan 20-30 sesiones iniciales realizadas 2-3 veces por semana, seguidas de sesiones de mantenimiento mensuales. El lupus requiere tratamiento a largo plazo.'
                            },
                            {
                                pregunta: '¿El tratamiento es seguro con lupus?',
                                respuesta: 'Sí, la ozonoterapia es segura y beneficiosa para pacientes con lupus. Ayuda a modular el sistema inmune sin suprimirlo, a diferencia de muchos medicamentos convencionales.'
                            },
                            {
                                pregunta: '¿Ayuda con las manifestaciones en la piel?',
                                respuesta: 'Sí, la ozonoterapia puede mejorar significativamente las lesiones cutáneas del lupus, incluida la erupción característica en forma de mariposa y otras manifestaciones dermatológicas.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Controla tu lupus y mejora tu calidad de vida. Agenda tu cita y recupera tu bienestar.
                    </p>
