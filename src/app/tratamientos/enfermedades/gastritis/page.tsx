        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/gastritis.png"
                        alt="Tratamiento para Gastritis"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">gastritis</strong> es la inflamación del revestimiento del estómago que puede ser aguda o crónica, causando dolor abdominal, náuseas y malestar digestivo que afecta la calidad de vida.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento complementario efectivo para la gastritis, reduciendo la inflamación gástrica, promoviendo la cicatrización de la mucosa y mejorando los síntomas digestivos.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Dolor o ardor en estómago',
                                    'Náuseas y vómitos',
                                    'Sensación de plenitud',
                                    'Pérdida de apetito',
                                    'Indigestión',
                                    'Eructos frecuentes',
                                    'Heces oscuras (casos graves)'
                                ].map((sintoma, index) => (
                                    <div key={index} className="flex items-start space-x-3">
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento complementario ayuda a sanar la mucosa gástrica
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye la inflamación de la mucosa gástrica'
                            },
                            {
                                icon: Activity,
                                title: 'Promueve Cicatrización',
                                description: 'Acelera la regeneración del revestimiento del estómago'
                            },
                            {
                                icon: Heart,
                                title: 'Alivia el Dolor',
                                description: 'Reduce el dolor y ardor estomacal significativamente'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Efecto Antibacteriano',
                                description: 'Ayuda a combatir H. pylori y otras bacterias'
                            },
                            {
                                icon: Clock,
                                title: 'Mejora la Digestión',
                                description: 'Optimiza la función digestiva y absorción de nutrientes'
                            },
                            {
                                icon: Star,
                                title: 'Previene Úlceras',
                                description: 'Reduce el riesgo de progresión a úlceras gástricas'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción del dolor estomacal, mejora en la digestión y disminución de síntomas desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 10-15 sesiones para gastritis crónica, con sesiones de mantenimiento según evolución. Debe combinarse con dieta apropiada y medicación si es indicada por su gastroenterólogo.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Sin efectos secundarios gástricos</li>
                                        <li>• Mejora respuesta a inhibidores de bomba</li>
                                        <li>• Reduce recurrencias</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede curar la gastritis?',
                                respuesta: 'La ozonoterapia es un tratamiento complementario muy efectivo que ayuda a reducir la inflamación, promover la cicatrización y aliviar los síntomas. Para cura completa, debe combinarse con tratamiento médico y cambios en el estilo de vida.'
                            },
                            {
                                pregunta: '¿Puedo dejar los inhibidores de bomba de protones?',
                                respuesta: 'No. La ozonoterapia complementa el tratamiento médico, no lo reemplaza. Cualquier cambio en medicación debe ser indicado únicamente por su gastroenterólogo.'
                            },
                            {
                                pregunta: '¿El tratamiento ayuda con la infección por H. pylori?',
                                respuesta: 'Sí, la ozonoterapia tiene efecto antibacteriano que ayuda a combatir H. pylori. Se usa como complemento del tratamiento antibiótico tradicional, mejorando los resultados.'
                            },
                            {
                                pregunta: '¿Qué dieta debo seguir?',
                                respuesta: 'Es importante evitar alimentos irritantes, picantes, alcohol, café y comidas grasas. Nuestro equipo puede orientarte sobre una dieta antiinflamatoria apropiada para gastritis.'
                            },
                            {
                                pregunta: '¿Cuándo veré resultados?',
                                respuesta: 'La mayoría de pacientes comienzan a notar reducción del dolor y mejora digestiva en 2-3 semanas. La mejoría es progresiva y continúa con el tratamiento completo.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Sana tu estómago y mejora tu digestión. Agenda tu cita y recupera tu bienestar.
                    </p>
