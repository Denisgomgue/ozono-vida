...
export default function InsuficienciaVascularPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/insuficiencia_vascular.png"
                        alt="Tratamiento para Insuficiencia Vascular"
                        fill
            ...
            {/* ¿Qué es la Insuficiencia Vascular? */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">insuficiencia vascular</strong> es una condición donde el flujo sanguíneo hacia las extremidades está reducido debido a estrechamiento o bloqueo de los vasos sanguíneos, causando dolor, debilidad y complicaciones graves.
                                </p>
                                <p>
                                    La ozonoterapia es altamente efectiva para tratar la insuficiencia vascular, mejorando la circulación, oxigenación de tejidos, y promoviendo la formación de nuevos vasos sanguíneos (angiogénesis).
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece múltiples beneficios para mejorar la circulación
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Aumenta el flujo sanguíneo hacia las extremidades afectadas'
                            },
                            {
                                icon: Activity,
                                title: 'Oxigena los Tejidos',
                                description: 'Mejora la oxigenación y nutrición de los tejidos'
                            },
                            {
                                icon: Heart,
                                title: 'Promueve Angiogénesis',
                                description: 'Estimula la formación de nuevos vasos sanguíneos'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce el Dolor',
                                description: 'Alivia el dolor al caminar y mejora la distancia de marcha'
                            },
                            {
                                icon: Clock,
                                title: 'Evita Amputaciones',
                                description: 'Previene complicaciones graves y la necesidad de cirugía'
                            },
                            {
                                icon: Star,
                                title: 'Acelera Cicatrización',
                                description: 'Favorece la curación de úlceras y heridas vasculares'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan mejoras significativas en la circulación y reducción del dolor desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 15-20 sesiones iniciales, seguido de sesiones de mantenimiento mensuales. En casos severos, puede prevenir amputaciones y mejorar dramáticamente la calidad de vida.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Alternativa no quirúrgica efectiva</li>
                                        <li>• Sin riesgos de procedimientos invasivos</li>
                                        <li>• Mejora sostenida de la circulación</li>
                                        <li>• Previene complicaciones graves</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Mejora en circulación</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede evitar una amputación?',
                                respuesta: 'En muchos casos sí. La ozonoterapia ha demostrado ser efectiva para mejorar la circulación y evitar amputaciones en pacientes con insuficiencia vascular severa, especialmente cuando se inicia tempranamente.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo tarda en mejorar la circulación?',
                                respuesta: 'Los pacientes suelen experimentar mejoras notables en 3-5 semanas. El dolor al caminar disminuye y aumenta la distancia que pueden recorrer sin molestias.'
                            },
                            {
                                pregunta: '¿El tratamiento es compatible con mis medicamentos?',
                                respuesta: 'Sí, la ozonoterapia es compatible con medicamentos para la circulación, anticoagulantes y otros tratamientos. De hecho, suele potenciar sus efectos.'
                            },
                            {
                                pregunta: '¿Puedo hacer ejercicio durante el tratamiento?',
                                respuesta: 'Sí, se recomienda caminar regularmente según tolerancia. El ejercicio moderado complementa el tratamiento y mejora los resultados.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden ser duraderos con sesiones de mantenimiento y modificación de factores de riesgo como dejar de fumar, controlar diabetes y mantener una dieta saludable.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Mejora tu circulación y previene complicaciones. Agenda tu cita y recupera tu movilidad.
                    </p>
