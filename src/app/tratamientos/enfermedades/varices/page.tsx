        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/varices.png"
                        alt="Tratamiento para Varices"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Las <strong className="text-corporate-blue">varices</strong> son venas hinchadas y retorcidas que se pueden ver debajo de la piel, generalmente en las piernas. Ocurren cuando las válvulas venosas no funcionan correctamente, causando acumulación de sangre.
                                </p>
                                <p>
                                    La ozonoterapia es muy efectiva para tratar varices, mejorando la circulación venosa, reduciendo la inflamación y fortaleciendo las paredes venosas, ofreciendo resultados sin necesidad de cirugía invasiva.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    'Venas visibles azules o moradas',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece mejoras significativas sin cirugía invasiva
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Optimiza el retorno venoso y reduce la estasis sanguínea'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la hinchazón y mejora el aspecto de las venas'
                            },
                            {
                                icon: Heart,
                                title: 'Fortalece Venas',
                                description: 'Mejora la elasticidad y resistencia de las paredes venosas'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Alivia Síntomas',
                                description: 'Reduce dolor, pesadez y calambres en las piernas'
                            },
                            {
                                icon: Clock,
                                title: 'Sin Cirugía',
                            ...
                            },
                            {
                                ...
                                description: 'Evita progresión y formación de úlceras varicosas'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción visible de varices, disminución del dolor y mejora en la circulación desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 10-15 sesiones para resultados óptimos, con sesiones de mantenimiento cada 2-3 meses. Los resultados son progresivos y duraderos.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Mejora estética y funcional</li>
                        ...
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Mejora en apariencia y síntomas</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede eliminar completamente las varices?',
                                respuesta: 'La ozonoterapia puede reducir significativamente la apariencia de las varices y mejorar los síntomas. En varices pequeñas y medianas, los resultados son muy buenos. Varices muy grandes pueden requerir tratamientos combinados.'
                            },
                            {
                                pregunta: '¿El tratamiento es doloroso?',
                                respuesta: 'No, el tratamiento es prácticamente indoloro. Algunas personas pueden sentir una ligera molestia en el punto de aplicación, pero es muy bien tolerado.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito?',
                                respuesta: 'Generalmente se recomiendan 10-15 sesiones realizadas 2 veces por semana. El número exacto depende del tamaño y severidad de las varices.'
                            },
                            {
                                pregunta: '¿Puedo hacer ejercicio después del tratamiento?',
                                respuesta: 'Sí, de hecho se recomienda caminar después de cada sesión. El ejercicio moderado ayuda a mejorar los resultados del tratamiento.'
                            },
                            {
                                pregunta: '¿Las varices pueden volver después del tratamiento?',
                                respuesta: 'Con buenos hábitos (ejercicio regular, mantener peso saludable, usar medias de compresión si es necesario), los resultados son duraderos. Sesiones de mantenimiento ayudan a prevenir recurrencias.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Mejora la apariencia y salud de tus piernas. Agenda tu cita y recupera tu bienestar.
                    </p>
