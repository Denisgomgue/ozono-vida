        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/colitis_ulcerosa.png"
                        alt="Tratamiento para Colitis Ulcerosa"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">colitis ulcerosa</strong> es una enfermedad inflamatoria intestinal crónica que causa inflamación y úlceras en el revestimiento del colon y recto, provocando dolor abdominal, diarrea y sangrado rectal.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento complementario efectivo para la colitis ulcerosa, reduciendo la inflamación intestinal, modulando el sistema inmunológico y mejorando significativamente los síntomas.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    'Estrés emocional',
                                    'Dieta inadecuada',
                                    'Desequilibrio de flora intestinal',
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento complementario ofrece alivio significativo de los síntomas
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye significativamente la inflamación intestinal'
                            },
                            {
                                icon: Activity,
                                title: 'Modula el Sistema Inmune',
                                description: 'Regula la respuesta autoinmune del organismo'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora la Cicatrización',
                                description: 'Favorece la curación de úlceras intestinales'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Reduce Brotes',
                                description: 'Disminuye la frecuencia e intensidad de los brotes'
                            },
                            {
                                icon: Clock,
                                title: 'Alivia Síntomas',
                                description: 'Reduce dolor, diarrea y sangrado intestinal'
                            },
                            {
                                icon: Star,
                                title: 'Mejora Calidad de Vida',
                                description: 'Permite llevar una vida más normal y activa'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan reducción de síntomas, disminución de brotes y mejora en la calidad de vida desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo inicial de 15-20 sesiones, seguido de sesiones de mantenimiento mensuales. Debe combinarse con tratamiento médico convencional y dieta apropiada.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Complementa tratamiento médico convencional</li>
                                        <li>• Sin efectos secundarios adversos</li>
                                        <li>• Mejora respuesta a otros tratamientos</li>
                                        <li>• Reduce necesidad de esteroides</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia puede curar la colitis ulcerosa?',
                                respuesta: 'La ozonoterapia no cura la colitis ulcerosa, pero es un tratamiento complementario muy efectivo que ayuda a controlar los síntomas, reducir brotes y mejorar significativamente la calidad de vida.'
                            },
                            {
                                pregunta: '¿Puedo dejar mis medicamentos?',
                                respuesta: 'No. La ozonoterapia complementa el tratamiento médico convencional, no lo reemplaza. Cualquier ajuste en medicación debe ser realizado solo por su gastroenterólogo.'
                            },
                            {
                                pregunta: '¿Cuántas sesiones necesito?',
                                respuesta: 'Se recomiendan 15-20 sesiones iniciales realizadas 2-3 veces por semana, seguidas de sesiones de mantenimiento mensuales. El plan se ajusta según la respuesta individual.'
                            },
                            {
                                pregunta: '¿El tratamiento ayuda durante los brotes?',
                                respuesta: 'Sí, la ozonoterapia puede ayudar a controlar y reducir la intensidad de los brotes, así como a disminuir su frecuencia cuando se usa regularmente.'
                            },
                            {
                                pregunta: '¿Qué dieta debo seguir?',
                                respuesta: 'Además del tratamiento, es importante seguir una dieta antiinflamatoria recomendada por su médico o nutricionista. Nuestro equipo puede orientarte sobre hábitos alimenticios beneficiosos.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Controla tus síntomas y mejora tu calidad de vida. Agenda tu cita y recupera tu bienestar.
                    </p>
