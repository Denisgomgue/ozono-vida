        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/enfermedades/prostatitis_cronica.png"
                        alt="Tratamiento para Prostatitis"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">prostatitis</strong> es la inflamación de la glándula prostática que causa dolor pélvico, dificultad para orinar y molestias que afectan significativamente la calidad de vida del hombre.
                                </p>
                                <p>
                                    La ozonoterapia ha demostrado ser altamente efectiva para tratar la prostatitis crónica, reduciendo la inflamación, aliviando el dolor y mejorando la función prostática sin efectos secundarios.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Nuestro tratamiento ofrece alivio efectivo de los síntomas prostáticos
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Disminuye significativamente la inflamación de la próstata'
                            },
                            {
                                icon: Activity,
                                title: 'Alivia el Dolor',
                                description: 'Reduce el dolor pélvico y mejora la calidad de vida'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora la Micción',
                                description: 'Facilita el flujo urinario y reduce la urgencia'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Efecto Antibacteriano',
                                description: 'Ayuda a eliminar infecciones bacterianas'
                            },
                            {
                                icon: Clock,
                                title: 'Mejora la Circulación',
                                description: 'Optimiza el flujo sanguíneo en la zona prostática'
                            },
                            {
                                icon: Star,
                                title: 'Sin Efectos Secundarios',
                                description: 'Tratamiento natural sin complicaciones'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Los pacientes experimentan alivio significativo del dolor y mejora en los síntomas urinarios desde las primeras semanas de tratamiento.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 10-15 sesiones para resultados óptimos, con sesiones de mantenimiento cada 2-3 meses en casos crónicos. La mayoría de pacientes logran mejoría sustancial.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        <li>• Compatible con antibióticos</li>
                                        <li>• Mejora función sexual</li>
                        ...
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Tasa de mejoría significativa</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia cura la prostatitis crónica?',
                                respuesta: 'La ozonoterapia es muy efectiva para controlar y reducir significativamente los síntomas de la prostatitis crónica. Muchos pacientes logran remisión completa de los síntomas con tratamiento adecuado.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo tarda en hacer efecto?',
                                respuesta: 'La mayoría de pacientes comienzan a notar mejoría en 2-4 semanas, con reducción del dolor y mejor flujo urinario. La mejoría continúa progresivamente con el tratamiento.'
                            },
                            {
                                pregunta: '¿Puedo combinar la ozonoterapia con antibióticos?',
                                respuesta: 'Sí, la ozonoterapia es compatible y complementa el tratamiento con antibióticos. De hecho, puede potenciar su efectividad en casos de prostatitis bacteriana.'
                            },
                            {
                                pregunta: '¿El tratamiento afecta la función sexual?',
                                respuesta: 'Al contrario, al reducir la inflamación y el dolor, muchos pacientes reportan mejora en su función sexual y reducción del malestar durante las relaciones.'
                            },
                            {
                                pregunta: '¿Los resultados son permanentes?',
                                respuesta: 'Los resultados pueden ser duraderos con buenos hábitos. Algunos pacientes pueden necesitar sesiones de mantenimiento, especialmente en casos de prostatitis crónica recurrente.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Recupera tu salud prostática y calidad de vida. Agenda tu cita y elimina las molestias.
                    </p>
