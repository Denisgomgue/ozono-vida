        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/ginecologia/endometriosis.png"
                        alt="Tratamiento para Endometriosis"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">endometriosis</strong> es una enfermedad crónica donde tejido similar al revestimiento uterino crece fuera del útero, causando dolor intenso, sangrado abundante e infertilidad en muchos casos.
                                </p>
                                <p>
                                    La ozonoterapia ofrece un tratamiento complementario efectivo para la endometriosis, reduciendo significativamente el dolor, la inflamación y mejorando la calidad de vida sin los efectos secundarios de tratamientos hormonales.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Alivio significativo del dolor y mejora de la calidad de vida
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Alivio significativo del dolor pélvico y menstrual'
                            },
                            {
                                icon: Activity,
                                title: 'Reduce la Inflamación',
                                description: 'Disminuye la inflamación de tejidos afectados'
                            },
                            {
                                icon: Heart,
                                title: 'Mejora la Fertilidad',
                                description: 'Puede mejorar las posibilidades de embarazo'
                            },
                            {
                                icon: CheckCircle,
                            ...
                            },
                            {
                                icon: Clock,
                                title: 'Sin Hormonas',
                                description: 'Alternativa a tratamientos hormonales con efectos secundarios'
                            },
                            {
                                icon: Star,
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Las pacientes experimentan reducción significativa del dolor pélvico, mejora en síntomas menstruales y mejor calidad de vida desde las primeras semanas.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 15-25 sesiones como complemento al tratamiento ginecológico, con sesiones de mantenimiento mensuales. La endometriosis requiere manejo a largo plazo.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Complementa tratamiento médico y quirúrgico</li>
                                        <li>• Reduce necesidad de analgésicos</li>
                                        <li>• Sin efectos de terapias hormonales</li>
                                        <li>• Mejora respuesta a fertilidad</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Semanas para reducir dolor</div>
                                </div>
                                <div className="text-center">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Reducción en dolor pélvico</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia cura la endometriosis?',
                                respuesta: 'La endometriosis no tiene cura definitiva, pero la ozonoterapia es muy efectiva para controlar el dolor, reducir la inflamación y mejorar significativamente la calidad de vida de las pacientes.'
                            },
                            {
                                pregunta: '¿Puedo quedar embarazada durante el tratamiento?',
                                respuesta: 'Sí, de hecho, la ozonoterapia puede mejorar las posibilidades de embarazo al reducir la inflamación pélvica. Muchas pacientes logran concebir después del tratamiento.'
                            },
                            {
                                pregunta: '¿Puedo dejar los tratamientos hormonales?',
                                respuesta: 'La ozonoterapia complementa los tratamientos hormonales, no los reemplaza. Algunos pacientes pueden reducir dosis bajo supervisión médica, pero cualquier cambio debe ser aprobado por su ginecólogo.'
                            },
                            {
                                pregunta: '¿El tratamiento ayuda si ya me operaron?',
                                respuesta: 'Sí, la ozonoterapia es excelente como tratamiento post-quirúrgico para prevenir recurrencias y controlar síntomas residuales después de cirugía de endometriosis.'
                            },
                            {
                                pregunta: '¿Cuánto tiempo dura el alivio del dolor?',
                                respuesta: 'Con el protocolo completo y sesiones de mantenimiento, muchas pacientes mantienen control del dolor por 6-12 meses. El tratamiento continuo puede proporcionar alivio sostenido.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Controla el dolor de la endometriosis y mejora tu calidad de vida. Agenda tu cita ahora.
                    </p>
