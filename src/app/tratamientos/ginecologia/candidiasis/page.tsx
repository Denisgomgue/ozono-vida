...
export default function CandidiasisPage() {
        ...
        <div className="services-page min-h-screen bg-white dark:bg-gray-900">
            ...
            <section className="relative bg-gradient-to-br from-corporate-blue to-corporate-blue-dark min-h-[60vh] flex items-center text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/treatments/ginecologia/candidiasis.png"
                        alt="Tratamiento para Candidiasis"
                        fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    La <strong className="text-corporate-blue">candidiasis vaginal</strong> es una infección causada por el hongo Candida, generalmente Candida albicans, que produce picazón intensa, flujo blanco espeso, irritación y malestar significativo.
                                </p>
                                <p>
                                    La ozonoterapia es altamente efectiva para tratar la candidiasis, eliminando el hongo, restaurando el pH vaginal, fortaleciendo la flora normal y previniendo recurrencias sin los efectos secundarios de tratamientos convencionales.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-corporate-text-muted dark:text-gray-300 max-w-3xl mx-auto">
                            Eliminación efectiva de la infección por hongos
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Shield,
                                title: 'Efecto Antifúngico',
                                description: 'Elimina Candida y otros hongos de forma efectiva'
                            },
                            {
                                icon: Activity,
                                title: 'Alivia Rápidamente',
                                description: 'Reduce picazón y malestar desde la primera sesión'
                            },
                            {
                                icon: Heart,
                                title: 'Restaura Flora Vaginal',
                                description: 'Reequilibra el pH y la microbiota natural'
                            },
                            {
                                icon: CheckCircle,
                                title: 'Previene Recurrencias',
                                description: 'Reduce significativamente la recaída de infecciones'
                            },
                            {
                                icon: Clock,
                                title: 'Sin Efectos Secundarios',
                                description: 'No causa irritación ni desequilibrio como antifúngicos'
                            },
                            {
                                icon: Star,
                                title: 'Resultados Duraderos',
                                description: 'Control a largo plazo con tratamiento completo'
                            }
                        ].map((beneficio, index) => (
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-corporate-text-muted dark:text-gray-300 leading-relaxed">
                                <p>
                                    Las pacientes experimentan alivio de la picazón y molestias desde la primera sesión, con resolución completa de la infección en pocos días.
                                </p>
                                <p>
                                    Se recomienda un protocolo de 3-5 sesiones para infección aguda, y 6-8 sesiones para casos recurrentes. El tratamiento previene eficazmente nuevos episodios.
                                </p>
                                <div className="bg-corporate-blue/10 rounded-xl p-6 border-l-4 border-corporate-blue">
                                    ...
                                    <ul className="space-y-2">
                                        <li>• Alivio inmediato de síntomas</li>
                                        <li>• Sin resistencia a antifúngicos</li>
                                        <li>• No altera la flora vaginal normal</li>
                                        <li>• Reduce recurrencias significativamente</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-corporate-blue/10 to-corporate-blue-light/10 rounded-2xl p-8">
                            <div className="grid grid-cols-1 gap-6">
                                <div className="text-center">
                                    ...
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Días para alivio de síntomas</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">3-5</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Sesiones para infección aguda</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-bold text-corporate-blue mb-2">90%</div>
                                    <div className="text-corporate-text-muted dark:text-gray-300 font-medium">Tasa de curación completa</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                pregunta: '¿La ozonoterapia cura la candidiasis recurrente?',
                                respuesta: 'Sí, la ozonoterapia es muy efectiva para candidiasis recurrente. Elimina el hongo, restaura el equilibrio vaginal y fortalece las defensas locales, reduciendo dramáticamente las recaídas.'
                            },
                            {
                                pregunta: '¿Cuándo sentiré alivio?',
                                respuesta: 'La mayoría de pacientes experimentan alivio significativo de la picazón y ardor después de la primera sesión, con mejora progresiva en 24-48 horas.'
                            },
                            {
                                pregunta: '¿El tratamiento es doloroso?',
                                respuesta: 'No, el tratamiento es completamente indoloro. De hecho, proporciona alivio inmediato de las molestias causadas por la infección.'
                            },
                            {
                                pregunta: '¿Puedo tener relaciones durante el tratamiento?',
                                respuesta: 'Se recomienda abstinencia sexual durante el tratamiento activo para permitir la recuperación completa de los tejidos. Su médico le indicará cuándo puede retomar la actividad sexual.'
                            },
                            {
                                pregunta: '¿Cómo prevenir que vuelva a aparecer?',
                                respuesta: 'Es importante mantener buena higiene íntima, usar ropa interior de algodón, evitar duchas vaginales, controlar la diabetes si la hay, y hacer sesiones de mantenimiento si se tiene tendencia a recurrencias.'
                            }
                        ].map((faq, index) => (
            ...
            <section className="py-20 bg-gradient-to-br from-corporate-blue to-corporate-blue-dark text-white">
                <div className="container mx-auto px-4 md:px-8 lg:px-4 max-w-7xl text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-cyan-100 leading-relaxed">
                        Elimina la candidiasis y recupera tu bienestar íntimo. Agenda tu cita ahora.
                    </p>
